<template>
  <v-card @mouseleave="entered=false" @mouseenter="entered=true" color="light-green lighten-5" class="mb-5" max-width="1000" min-width="300" width="800" @click="oznaciProcitan">
